jQuery(function ($) {
	...
	/* Start "Short Term Rental", "Hotel Resort" & "Property Listing" Demo Style CSS
	================================================================================*/

	// Listing Images Slider JS
	$('.listing-images-slider').owlCarousel({
		loop: true,
		margin: 15,
		nav: false,
		dots: true,
	...
	// Hotel Features Slider JS
	var swiper = new Swiper(".hotel-features-slider", {
		loop: true,
		spaceBetween: 55,
		centeredSlides: true,
		autoplay: {
	...
	// Hotel Blog Slider JS
	var swiper = new Swiper(".hotel-blog-slider", {
		loop: true,
		spaceBetween: 55,
		autoplay: {
			delay: 3000,
	...
	// Hotel Instagram Slider JS
	var swiper = new Swiper(".hotel-instagram-slider", {
		loop: true,
		spaceBetween: 25,
		autoplay: {
			delay: 3000,
	...
	// Property Locations Slider JS
	var swiper = new Swiper(".property-locations-slider", {
		loop: true,
		spaceBetween: 55,
		centeredSlides: true,
		autoplay: {
	...
	// Property Testimonial Slider JS
	var swiper = new Swiper(".property-testimonial-slider", {
		loop: true,
		spaceBetween: 25,
		autoplay: {
			delay: 3000,
	...
	/* End "Short Term Rental", "Hotel Resort" & "Property Listing" Demo Style CSS
	================================================================================*/

	/* Start "Real Estate Agent Portfolio", "Single Property" & "Mortgage Offerings Listing" Demo Style CSS
	================================================================================*/

	// REAP Testimonial Slider JS
	$('.reap-testimonial-slider').owlCarousel({
		loop: true,
		margin: 25,
		nav: false,
		dots: true,
	...
	// MOL Testimonial Slider JS
	$('.mol-testimonial-slider').owlCarousel({
		loop: true,
		margin: 25,
		nav: false,
		dots: true,
